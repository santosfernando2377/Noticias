...
function NoticiaNeg () {
    ...
    document.title = "Notícias - Negocíos"

    const [Filtro, setFiltro] = useState([]);
    
        useEffect(() =>{
            axios.get("https://content.guardianapis.com/search?q=business&page-size=30&api-key=8f84a630-4947-4f2f-a327-41b5228c132d")
            .then((response) =>{
